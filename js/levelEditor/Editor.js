...
    // --- GEWIJZIGD: Nieuwe enemies toegevoegd aan de lijst ---
    var elements = [
      'cell',
      'platform',
      'coin-box',
...
      'pipe-top-left',
      'pipe-top-right',
      'goomba', // Bestaande Goomba
      'browser', // Nieuw: Enemy browser
      'piranha', // Nieuw: Enemy Piranhaplant
      'pumpkin', // Nieuw: Enemy pumpkin
      'koopa' // Nieuw: Enemy koopa
    ];
    // --------------------------------------------------------
    var element;
...
            break;
            
          // --- NIEUW: Enemies toevoegen aan de map generatie met unieke codes ---
          case 'koopa':
            value = 21; // Nieuwe code voor Koopa
            break;
          case 'piranhaplant':
            value = 22; // Nieuwe code voor Piranhaplant
            break;
          case 'buzzybeetle':
            value = 23; // Nieuwe code voor Buzzy Beetle
            break;
          case 'spiny':
            value = 24; // Nieuwe code voor Spiny
            break;
          // ----------------------------------------------------------------------
          case 'flag-pole':
            value = 5;
